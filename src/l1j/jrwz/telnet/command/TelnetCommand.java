 ...
 */
package l1j.jrwz.telnet.command;

import static l1j.jrwz.telnet.command.TelnetCommandResult.CMD_INTERNAL_ERROR;
import static l1j.jrwz.telnet.command.TelnetCommandResult.CMD_OK;
...
import l1j.jrwz.server.storage.mysql.MySqlCharacterStorage;
