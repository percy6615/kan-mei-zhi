...
import static l1j.jrwz.server.ActionCodes.ACTION_Attack;
import static l1j.jrwz.server.ActionCodes.ACTION_AxeAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_AxeWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_BowAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_BowWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_ClawAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_ClawWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_DaggerAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_DaggerWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_EdoryuAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_EdoryuWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_SkillAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_SkillBuff;
import static l1j.jrwz.server.ActionCodes.ACTION_SpearAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_SpearWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_StaffAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_StaffWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_SwordAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_SwordWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_ThrowingKnifeAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_ThrowingKnifeWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_TwoHandSwordAttack;
import static l1j.jrwz.server.ActionCodes.ACTION_TwoHandSwordWalk;
import static l1j.jrwz.server.ActionCodes.ACTION_Walk;
