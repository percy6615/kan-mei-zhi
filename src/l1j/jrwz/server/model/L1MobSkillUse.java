...
import l1j.jrwz.server.templates.L1MobSkill;
...
public class L1MobSkillUse {
            ...
            case L1MobSkill.CHANGE_TARGET_RANDOM:
                ...
                for (L1Object obj : L1World.getInstance().getVisibleObjects(
                    ...
                    if (obj instanceof L1PcInstance
                        ...
                        int distance = _attacker.getLocation()
        ...
        try {
            ...
            if (skillid > 0) {
                canUseSkill = skillUse.checkUseSkill(null, skillid,
                        _target.getId(), _target.getX(), _target.getY(), null,
    ...
    private boolean useSkill(int i) {
        ...
        } else if (type == L1MobSkill.TYPE_SUMMON) { // 召唤
            if (summon(i) == true) {
                skillUseCountUp(i);
                isUseSkill = true;
            }
        } else if (type == L1MobSkill.TYPE_POLY) { // 强制变身
            if (poly(i) == true) {
                skillUseCountUp(i);
                isUseSkill = true;
            }
