...
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_ADDBUDDY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_AMOUNT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_ARROWATTACK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_ATTACK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_ATTR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BANCLAN;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BANPARTY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOARD;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOARDDELETE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOARDNEXT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOARDREAD;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOARDWRITE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOOKMARK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BOOKMARKDELETE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_BUDDYLIST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CAHTPARTY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CALL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHANGECHAR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHANGEHEADING;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHANGEWARTIME;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHARACTERCONFIG;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHARRESET;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHAT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHATGLOBAL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHATWHISPER;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CHECKPK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CLAN;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CLIENTVERSION;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_COMMONCLICK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CREATECLAN;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_CREATEPARTY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DELBUDDY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DELETECHAR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DELETEINVENTORYITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DEPOSIT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DOOR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DRAWAL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_DROPITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_EMBLEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_ENTERPORTAL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_EXCLUDE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_EXIT_GHOST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_EXTCOMMAND;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_FIGHT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_FISHCLICK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_FIX_WEAPON_LIST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_GIVEITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_HIRESOLDIER;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_JOINCLAN;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_KEEPALIVE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_LEAVECLANE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_LEAVEPARTY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_LOGINPACKET;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_LOGINTOSERVER;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_LOGINTOSERVEROK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_MAIL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_MOVECHAR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_NEWCHAR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_NPCACTION;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_NPCTALK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PARTYLIST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PETMENU;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PICKUPITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PLEDGE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PRIVATESHOPLIST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_PROPOSE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_QUITGAME;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_RANK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_RESTART;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_RESULT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_RETURNTOLOGIN;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SELECTLIST;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SELECTTARGET;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SHIP;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SHOP;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SKILLBUY;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_SKILLBUYOK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TAXRATE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TELEPORT;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TITLE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TRADE;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TRADEADDCANCEL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TRADEADDITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_TRADEADDOK;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_USEITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_USEPETITEM;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_USESKILL;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_WAR;
import static l1j.jrwz.server.codes.Opcodes.C_OPCODE_WHO;
