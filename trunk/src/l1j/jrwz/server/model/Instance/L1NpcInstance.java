...
//
import static l1j.jrwz.server.model.item.L1ItemId.B_POTION_OF_GREATER_HASTE_SELF;
import static l1j.jrwz.server.model.item.L1ItemId.B_POTION_OF_HASTE_SELF;
import static l1j.jrwz.server.model.item.L1ItemId.POTION_OF_EXTRA_HEALING;
import static l1j.jrwz.server.model.item.L1ItemId.POTION_OF_GREATER_HASTE_SELF;
import static l1j.jrwz.server.model.item.L1ItemId.POTION_OF_GREATER_HEALING;
import static l1j.jrwz.server.model.item.L1ItemId.POTION_OF_HASTE_SELF;
import static l1j.jrwz.server.model.item.L1ItemId.POTION_OF_HEALING;
...
import l1j.jrwz.server.model.L1GroundInventory;
import l1j.jrwz.server.model.L1HateList;
import l1j.jrwz.server.model.L1Inventory;
import l1j.jrwz.server.model.L1Magic;
import l1j.jrwz.server.model.L1MobGroupInfo;
import l1j.jrwz.server.model.L1MobSkillUse;
import l1j.jrwz.server.model.L1NpcChatTimer;
import l1j.jrwz.server.model.L1NpcRegenerationTimer;
import l1j.jrwz.server.model.L1Object;
import l1j.jrwz.server.model.L1Spawn;
...
import l1j.jrwz.server.templates.L1NpcChat;
import l1j.jrwz.server.types.Point;
import l1j.jrwz.server.utils.TimerPool;
