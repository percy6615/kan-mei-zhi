...
import static l1j.jrwz.server.model.skill.L1SkillId.HOLY_WEAPON;
import static l1j.jrwz.server.model.skill.L1SkillId.SHADOW_FANG;
...
import l1j.jrwz.server.model.L1EquipmentTimer;
import l1j.jrwz.server.model.L1ItemOwnerTimer;
...
import l1j.jrwz.server.utils.BinaryOutputStream;
    ...
    class EnchantTimer extends TimerTask {
        ...
        public void run() {
            try {
                ...
                setHolyDmgByMagic(0);
                setHitByMagic(0);
                _pc.sendPackets(new S_ServerMessage(L1SystemMessageId.$308, getLogName()));
                _isRunning = false;
                _timer = null;
            } catch (Exception e) {
            }
