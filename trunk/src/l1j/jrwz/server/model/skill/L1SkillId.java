...
public class L1SkillId {
    ...
    /** 古老的蓝色药水. */
    public static final int STATUS_BLUE_POTION_OLDER = 1028;
    /** 辅助状态结尾 */
    ...
    /** 毒雾-前方 3X3 */
    public static final int POISON_SMOG = 20011;

    // 自定义状态
    /** 套装状态:动画效果. */
    public static final int EFFECT_OF_ARMOR_SETS = 30000;
    /** 套装状态:获得特定道具. */
    public static final int EFFECT_ITEM_OF_ARMOR_SETS = 30001;
    /** 防具状态:动画效果. */
    public static final int EFFECT_OF_ARMOR = 30002;
    /** 防具状态:获得特定道具. */
    public static final int EFFECT_ITEM_OF_ARMOR = 30003;
    /** 经验加成倍率:神力药水. */
    public static final int EXP_BONUS_OF_POTION = 30004;
